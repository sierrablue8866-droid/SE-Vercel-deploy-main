...
(function () {
  ...
  var I18N = {
    en: {
      ...
      heroSub: 'The first real estate ecosystem in Egypt · 50+ compounds · 1,900+ units · AI-ranked, broker-verified.',
      ...
      crumbHome: 'Home',
      propsTit: 'Exclusive Properties', propsSub: 'AI-curated rental & resale inventory across New Cairo, meticulously verified on-site by our experts.',
      cpdsTit: 'Compound Intelligence Map', cpdsSub: 'Live insights on 50+ compounds across New Cairo, Madinaty & Shorouk, benchmarked by AI score, growth potential, and pricing.',
      searchCpdPh: 'Search by compound name…', filterByZone: 'Filter by zone', allZones: 'All zones', browseMap: 'Explore map', noCpd: 'No compounds match your exquisite criteria.', cpdCount: 'compounds',
      ...
      inqTit: 'Private Inquiry', inqSub: 'Detail your requirements. A dedicated advisor will reach out within 2 hours.',
      inqLook: 'I\u2019m looking to', inqBuy: 'Acquire', inqRent: 'Lease', inqSell: 'List',
      inqName: 'Full Name', inqEmail: 'Email Address', inqPhone: 'Phone Number', inqZone: 'Preferred District', inqType2: 'Property Category', inqBudget: 'Investment (EGP)', inqSend: 'Submit Request',
      partEye: 'Trusted developer partners',
      fDiscover: 'Discover',
      aiEye: 'AI · 7 tools online', aiTit: 'First AI real-estate ecosystem in the Middle East', aiSub: 'Live AI tools for every step — search, price, tour, close.',
      ...
      mapTit: 'Live Compound Map', mapSub: 'Explore all New Cairo compounds on the interactive map. Click any marker for details.', openFullMap: 'Open full map',
      insTit: 'Best Listings Right Now', insSub: 'AI-ranked by match score, ROI potential, and market demand. Updates in real-time.', insBtn: 'View all best listings',
    ...
    ar: {
      ...
      heroSub: 'أول منظومة عقارية في مصر · +50 كمبوند · +1900 وحدة · مرتّبة بالذكاء الاصطناعي، موثّقة من وسطائنا.',
      ...
      inqTit: 'طلب استشارة خاصة', inqSub: 'أخبرنا بتطلعاتك العقارية، وسيتواصل معك مستشارك الخاص خلال ساعتين.',
      inqLook: 'أرغب في', inqBuy: 'استثمار/شراء', inqRent: 'استئجار', inqSell: 'عرض عقاري',
      inqName: 'الاسم بالكامل', inqEmail: 'البريد الإلكتروني', inqPhone: 'رقم الهاتف', inqZone: 'المنطقة المفضلة', inqType2: 'فئة العقار', inqBudget: 'الميزانية (جنيه مصري)', inqSend: 'إرسال الطلب',
      partEye: 'شركاء التطوير الموثوقون',
      fDiscover: 'اكتشف',
      aiEye: 'ذكاء اصطناعي · 7 أدوات تعمل', aiTit: 'أول نظام ذكاء عقاري في الشرق الأوسط', aiSub: 'أدوات ذكاء اصطناعي حية لكل خطوة — بحث، تسعير، جولة، وإتمام.',
      ...
      mapTit: 'اكتشف أفضل الفرص', mapSub: 'استكشف كل كمبوندات القاهرة الجديدة على الخريطة التفاعلية — اضغط أي علامة للتفاصيل.', openFullMap: 'افتح الخريطة كاملة',
      insTit: 'أفضل العقارات الآن', insSub: 'مرتبة بالذكاء الاصطناعي حسب التوافق والعائد والطلب — تتحدّث لحظياً.', insBtn: 'عرض كل أفضل العقارات',
