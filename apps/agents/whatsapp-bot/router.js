   ...
   async runCloserAgent(phone, userMessage) {
    try {
      ...
      const context = {
        dealId: deal.id,
        leadPhone: phone,
        propertyCode: (dealData.propertyCode ) || (dealData.assetId ) || 'N/A',
        buyerProfile: (dealData.buyerProfile ) || {},
        propertyData: (dealData.propertyData ) || {},
        previousOffers: (dealData.previousOffers ) || [],
        negotiationHistory: (dealData.negotiationHistory ) || [],
      }
