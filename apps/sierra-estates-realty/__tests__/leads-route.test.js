 function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }const insertRecordMock = jest.fn();
...
jest.mock('@/lib/telegram', () => ({
  ...
  escapeTelegramHtml: (value) =>
    String(_nullishCoalesce(value, () => ( ''))).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;'),
}));
