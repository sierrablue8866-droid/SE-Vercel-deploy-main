 ...
 */
import { processAndRankInventory, } from '../lib/utils/searchRanking';
...
const scoreOf = (l) => (l )._calculatedScore ;
...
describe('visibility filter', () => {
  ...
  it('requires isPublishedToClientPage to be exactly true, not merely truthy', () => {
    const truthy = { ...listing('a', 9, 0), isPublishedToClientPage: 1  };
...
describe('immutability and shape', () => {
  it('does not mutate the input listings', () => {
    ...
    expect((input[0] )._calculatedScore).toBeUndefined();
  });
