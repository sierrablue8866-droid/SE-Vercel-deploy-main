...
function request(headers = {}) {
  return new NextRequest('https://sierra-estates.net/api/anything', { headers } );
}

/** Import the module fresh so the module-level SECRET_KEY picks up the env. */
async function loadGuard(secret) {
