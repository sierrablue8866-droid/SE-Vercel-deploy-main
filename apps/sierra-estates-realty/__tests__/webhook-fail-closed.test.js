...
jest.mock('@sierra-estates/db', () => ({
  insertRecord: (...a) => insertRecordMock(...a),
  listRecords: (...a) => listRecordsMock(...a),
}));

jest.mock('@/lib/services/WhatsAppStatusService', () => ({
  WhatsAppStatusService: { recordHeartbeat: (...a) => recordHeartbeat(...a) },
}));

jest.mock('@/lib/services/WhatsAppParserService', () => ({
  WhatsAppParserService: {
    parseMessage: (...a) => parseMessage(...a),
    processIncomingMessage: (...a) => processIncomingMessage(...a),
  },
}));

jest.mock('@/lib/services/WhatsAppConversationalService', () => ({
  WhatsAppConversationalService: {
    processDirectMessage: (...a) => processDirectMessage(...a),
  },
}));
...
async function loadRoute(modulePath, nodeEnv) {
  setNodeEnv(nodeEnv);
  jest.resetModules();
