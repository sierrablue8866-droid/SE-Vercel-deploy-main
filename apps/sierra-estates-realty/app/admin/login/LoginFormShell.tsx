...
// `export const dynamic = 'force-dynamic'` on the page itself, and Vercel's
// builder couldn't resolve the ambiguity ("Unable to find lambda for route:
// /admin/login"). Rendering client-only avoids the static shell entirely.
