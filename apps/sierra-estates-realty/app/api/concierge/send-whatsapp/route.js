 function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }import { buildPortfolioMessage } from '@/lib/services/portfolio-engine';
...
export const POST = async (req) => {
  ...
  try {
    ...
    const portfolioId = _optionalChain([portfolioSnap, 'access', _ => _.data, 'call', _2 => _2(), 'optionalAccess', _3 => _3.conciergePortfolioId]);
    ...
    const portfolio = { id: portfolioSnap2.id, ...portfolioSnap2.data() } ;
