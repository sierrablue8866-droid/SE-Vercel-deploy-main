...
export async function POST(req) {
  ...
  try {
    ...
    const locale = _nullishCoalesce(parsed.data.locale, () => ( 'en'));
    const limit = _nullishCoalesce(parsed.data.limit, () => ( 12));
    const offset = _nullishCoalesce(parsed.data.offset, () => ( 0));
    ...
    try {
      const userAgent = _nullishCoalesce(req.headers.get('user-agent'), () => ( undefined));
