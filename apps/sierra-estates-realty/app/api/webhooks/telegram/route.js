...
export async function POST(req) {
  try {
    ...
    const sender = _optionalChain([message, 'access', _ => _.from, 'optionalAccess', _2 => _2.username]) || _optionalChain([message, 'access', _3 => _3.from, 'optionalAccess', _4 => _4.first_name]) || 'Authorized User';
