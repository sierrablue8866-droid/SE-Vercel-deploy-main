    ...
    <div className={`min-h-screen bg-slate-950 text-slate-100 ${lang === 'ar' ? 'rtl' : 'ltr'}`} dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <figure className="rounded-2xl overflow-hidden border border-slate-700 bg-slate-900"><img src="/cairo-plaza/alfa-banque-misr-frontage.png" alt={lang === 'ar' ? 'واجهة البرج الحالية وتظهر بها لافتات معامل ألفا وبنك مصر' : 'Current tower frontage showing Alfa Labs and Banque Misr signage'} className="w-full h-72 object-cover" /><figcaption className="p-4 text-sm text-slate-300">{lang === 'ar' ? 'معامل ألفا وواجهة البرج وبنك مصر — صورة حقيقية للموقع الحالي' : 'Alfa Labs, tower frontage, and Banque Misr — current-site photograph'}</figcaption></figure>
          <figure className="rounded-2xl overflow-hidden border border-slate-700 bg-slate-900"><img src="/cairo-plaza/tower-frontage-detail.png" alt={lang === 'ar' ? 'تفاصيل واجهة برج كايرو بلازا الحالية' : 'Cairo Plaza current tower frontage detail'} className="w-full h-72 object-cover" /><figcaption className="p-4 text-sm text-slate-300">{lang === 'ar' ? 'تفاصيل واجهة البرج — صورة حقيقية محسّنة' : 'Tower frontage detail — enhanced real current-site photograph'}</figcaption></figure>
