...
const realEvidence: EvidenceImage[] = [
  {
    ...
    altEn: 'Main street entrance portal with Cairo Plaza Tower 1 signage and accredited medical facilities',
    altAr: 'المدخل والبوابة الرئيسية للمبنى من الشارع مع لافتة كايرو بلازا برج ١ والمراكز الطبية المعتمدة',
    titleEn: 'Tower 1 Main Portal',
    titleAr: 'مدخل كايرو بلازا برج ١',
    captionEn: 'Verified on-site photograph · Street-level staircase, Tower 1 branding, and medical anchor signage',
    captionAr: 'صورة حية موثقة للموقع · سلالم المدخل من الشارع ولافتة البرج والكيانات الطبية',
  },
  {
    src: '/cairo-plaza/site-photos/cp-interior-marble-stairs.jpg',
    altEn: 'Hotel-grade natural green marble entrance stairs, decorative iron gate, and greenery',
    altAr: 'مدخل رخامي فندقي فاخر ودرج داخلي وبوابة حماية حديدية ونباتات زينة',
    titleEn: 'Marble Entrance & Greenery',
    titleAr: 'المدخل الرخامي الفندقي',
    captionEn: 'Verified on-site photograph · Natural polished marble flooring, recessed lighting, and security gate',
    captionAr: 'صورة حية موثقة للموقع · أرضيات رخام طبيعي فاخرة، إضاءات سبوت لايت، وبوابة حماية مزخرفة',
  },
  {
    src: '/cairo-plaza/site-photos/cp-furnished-executive-office.jpg',
    altEn: 'Turnkey fully furnished modern executive office suite ready for immediate operation',
    altAr: 'مقر إداري ومكتب تنفيذي مؤثث بالكامل ومجهز بأحدث التجهيزات وجاهز للتشغيل الفوري',
    titleEn: 'Turnkey Executive Office',
    titleAr: 'مكتب تنفيذي جاهز للتشغيل',
    captionEn: 'Verified on-site photograph · Executive desks, ergonomic seating, porcelain tiling, and motivational art',
    captionAr: 'صورة حية موثقة للموقع · مكاتب عمل تنفيذية، كراسي مريحة، أرضيات بورسلين، وديكور جداري ملهم',
  },
  {
    src: '/cairo-plaza/site-photos/cp-corridor-elevator-hallway.jpg',
    altEn: 'Corporate upper-floor elevator lobby with granite floors and marble wall cladding',
    altAr: 'ممر المصاعد للأدوار الإدارية والعيادات بتشطيبات جرانيت ورخام وإشارات إرشادية',
    titleEn: 'Elevator Lobby & Corridor',
    titleAr: 'ممر المصاعد والأدوار',
    captionEn: 'Verified on-site photograph · Modern elevator access, granite floor borders, and medical signage',
    captionAr: 'صورة حية موثقة للموقع · مصاعد حديثة سريعة، تجاليد رخامية على الحوائط، ولافتات إرشادية',
  },
  {
    src: '/cairo-plaza/site-photos/cp-exterior-banque-misr-frontage.png',
    altEn: 'Street view of Cairo Plaza tower base anchored by operational Banque Misr branch',
    altAr: 'لقطة شاملة لواجهة البرج التجارية المباشرة مع فرع بنك مصر المتكامل وماكينات الصراف الآلي',
    titleEn: 'Banque Misr Anchor Frontage',
    titleAr: 'واجهة فرع بنك مصر بالبرج',
    captionEn: 'Verified on-site photograph · Fully operating commercial banking anchor and pedestrian plaza',
    captionAr: 'صورة حية موثقة للموقع · فرع بنك مصر المتكامل والواجهة التجارية والساحة المفتوحة',
  },
  {
...
const officialAdCampaigns: AdCampaign[] = [
  {
    ...
    titleEn: 'Cairo Plaza Commercial & Executive HQs',
    titleAr: 'امتلك أو استأجر مقرك التجاري في كايرو بلازا',
    descEn: 'Instant turnkey delivery with zero fit-out downtime, 24/7 security, and metro footfall.',
    descAr: 'ابدأ نشاطك فوراً بدون مصاريف أو فترات تشطيب مع أعلى معدل زيارات يومية.',
    ref: 'REF: SE-CP-DUAL',
  },
  {
    ...
    ref: 'REF: SE-CP-COLLAGE',
  },
  {
    src: '/cairo-plaza/ads/cairo-plaza-ad-roi-live.jpg',
    badgeEn: 'MAXIMUM YIELD',
    badgeAr: 'أعلى عائد مضمون',
    titleEn: 'High-Yield Commercial Investment',
    titleAr: 'استثمارك الأذكى في قلب الشريان التجاري',
    descEn: 'Institutional-grade investment with highest guaranteed annual yield and notarized contracts.',
    descAr: 'محلات ووحدات تجارية تحقق أعلى عائد سنوي مضمون مع كثافة سكانية وتدفق عملاء مستمر.',
    ref: 'REF: SE-CP-ROI-LIVE',
  },
  {
    src: '/cairo-plaza/ads/cairo-plaza-ad-vip.png',
    badgeEn: 'VIP LANDMARK',
    badgeAr: 'صرح تجاري VIP',
    titleEn: 'Cairo Plaza Premier Business Edifice',
    titleAr: 'صرح كايرو بلازا التجاري والإداري — VIP',
    descEn: 'Executive offices, retail flagships, Mitsubishi lifts, and flexible payment arrangements.',
    descAr: 'مقرات إدارية ومحلات تجارية وعيادات طبية متخصصة مع مدخل فندقي فاخر ومصاعد ميتسوبيشي.',
    ref: 'REF: SE-CP-VIP',
  },
  {
    src: '/cairo-plaza/ads/cairo-plaza-ad-evidence.jpg',
    badgeEn: 'LIVE PROOF',
    badgeAr: '٥ صور حية من المبنى',
    titleEn: 'Turnkey Units Ready for Immediate Launch',
    titleAr: 'فرصتك التجارية والاستثمارية في كايرو بلازا',
    descEn: 'Verified physical evidence: luxury marble entrances, rapid elevators, and ready utilities.',
    descAr: 'محلات ومكاتب وعيادات طبية جاهزة للتشغيل الفوري مع تسليم فوري للمفتاح.',
    ref: 'REF: SE-CP-EVIDENCE',
  },
  {
    src: '/cairo-plaza/ads/cairo-plaza-ad-turnkey.jpg',
    badgeEn: 'TURNKEY OFFICE',
    badgeAr: 'مكتب فوري مفروش',
    titleEn: 'Fully Furnished Executive Suite',
    titleAr: 'مقرك الإداري الفاخر.. جاهز فورا للتشغيل',
    descEn: 'Save setup capital and time with executive desks, climate control, meeting rooms, and high-speed internet.',
    descAr: 'وفر تكاليف ووقت التشطيب وابدأ عملك اليوم مع أثاث راقي وتكييفات وإنترنت فائق السرعة.',
    ref: 'REF: SE-CP-TURNKEY',
  },
  {
    src: '/cairo-plaza/ads/cairo-plaza-ad-square-hero.jpg',
    badgeEn: 'TRANSIT LANDMARK',
    badgeAr: 'واجهة فاخرة',
    titleEn: 'Cairo Plaza Transit-Oriented Landmark',
    titleAr: 'صرح كايرو بلازا — واجهة تجارية واستثمارية',
    descEn: 'Premier commercial destination with instant handover and high ROI.',
    descAr: 'صرح تجاري متكامل بموقع استراتيجي وترافيك بشري هائل.',
    ref: 'REF: SE-CP-HERO',
  },
  {
