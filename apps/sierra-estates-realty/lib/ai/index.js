...
function pickService() {
  const provider = (_nullishCoalesce(process.env.AI_PROVIDER, () => ( 'google'))).toLowerCase();
 ...
 */
export function _resetAIServiceCacheForTests() {
  cached = null;
 ...
 */
export const aiService = new Proxy({} , {
  get(_target, prop) {
