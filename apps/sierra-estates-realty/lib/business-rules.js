...
export const CURRENCY_THRESHOLD = 10000;
...
export function generateSBRCode(
  ...
  if (price < CURRENCY_THRESHOLD) {
    ...
    priceCode = `${(price / 1000000).toFixed(1)}M`;
  }
...
export function isValueHunterDeal(price, compoundMean) {
