...
const CORE_SKILLS = [
  ...
  { id: 'whatsapp-send',   name: 'WhatsApp Send',   description: 'Send WhatsApp messages via Twilio',    execute: async (p) => p },
  { id: 'telegram-alert',  name: 'Telegram Alert',  description: 'Send Telegram notifications',          execute: async (p) => p },
  { id: 'sheets-sync',     name: 'Sheets Sync',     description: 'Sync data with Google Sheets',         execute: async (p) => p },
  { id: 'crm-lookup',      name: 'CRM Lookup',      description: 'Look up lead data in Firestore CRM',   execute: async (p) => p },
];
