...
export const GAZETTEER: Record<string, GazetteerEntry> = {
  ...
  tagamoa: { lat: 30.02, lng: 31.52, label: '5th Settlement', zone: '5th Settlement' },
  ...
  sodic: { lat: 30.018, lng: 31.587, label: 'Eastown', zone: '5th Settlement' },
  ...
  'haid bark': { lat: 30.008, lng: 31.645, label: 'Hyde Park', zone: '5th Settlement' },
  'hayd park': { lat: 30.008, lng: 31.645, label: 'Hyde Park', zone: '5th Settlement' },
  ...
  lakeview: { lat: 30.022, lng: 31.532, label: 'Lake View Residence', zone: 'New Cairo' },
  'lake view res.': { lat: 30.022, lng: 31.532, label: 'Lake View Residence', zone: 'New Cairo' },
  narges: { lat: 30.052, lng: 31.47, label: 'Al Narges', zone: 'New Cairo' },
  'al narges': { lat: 30.052, lng: 31.47, label: 'Al Narges', zone: 'New Cairo' },
  'el narges': { lat: 30.052, lng: 31.47, label: 'Al Narges', zone: 'New Cairo' },
  'narges villas': { lat: 30.052, lng: 31.47, label: 'Al Narges', zone: 'New Cairo' },
  ...
  katameya: { lat: 29.99, lng: 31.48, label: 'Katameya Heights', zone: 'Katameya' },
  ...
  azad: { lat: 30.078, lng: 31.558, label: 'Azad & Azad Views', zone: 'Mostakbal' },
  ...
  'mountain view': { lat: 30.014, lng: 31.618, label: 'Mountain View iCity', zone: '5th Settlement' },
  ...
  'palm-hills': { lat: 30.002, lng: 31.608, label: 'Palm Hills New Cairo', zone: '5th Settlement' },
  'palm hills': { lat: 30.002, lng: 31.608, label: 'Palm Hills New Cairo', zone: '5th Settlement' },
  'palm hills new cairo': { lat: 30.002, lng: 31.608, label: 'Palm Hills New Cairo', zone: '5th Settlement' },
  'el shorouk city': { lat: 30.121, lng: 31.616, label: 'El Shorouk City', zone: 'El Shorouk' },
  'el shorouk': { lat: 30.121, lng: 31.616, label: 'El Shorouk City', zone: 'El Shorouk' },
  shorouk: { lat: 30.121, lng: 31.616, label: 'El Shorouk City', zone: 'El Shorouk' },
  ...
  'oriana (cfc)': { lat: 30.033, lng: 31.492, label: 'Oriana', zone: 'New Cairo' },
  ...
  andlos: { lat: 30.052, lng: 31.49, label: 'Al Andalus', zone: 'New Cairo' },
  andalus: { lat: 30.052, lng: 31.49, label: 'Al Andalus', zone: 'New Cairo' },
  'al andalus': { lat: 30.052, lng: 31.49, label: 'Al Andalus', zone: 'New Cairo' },
  'el andalus': { lat: 30.052, lng: 31.49, label: 'Al Andalus', zone: 'New Cairo' },
  ...
  zaid: { lat: 30.06, lng: 30.98, label: 'Sheikh Zayed', zone: 'Sheikh Zayed' },
  ...
  banafseg: { lat: 30.045, lng: 31.485, label: 'Al Banafsaj', zone: 'New Cairo' },
  'al banafsaj': { lat: 30.045, lng: 31.485, label: 'Al Banafsaj', zone: 'New Cairo' },
  'el banafseg': { lat: 30.045, lng: 31.485, label: 'Al Banafsaj', zone: 'New Cairo' },
  banfcg: { lat: 30.045, lng: 31.485, label: 'Al Banafsaj', zone: 'New Cairo' },
  ...
  'dar misr (el koronfel)': { lat: 30.065, lng: 31.495, label: 'Dar Misr (El Koronfel)', zone: 'New Cairo' },
  'eypet hose elkurfenl': { lat: 30.065, lng: 31.495, label: 'Dar Misr (El Koronfel)', zone: 'New Cairo' },
  'gardenia city': { lat: 30.082, lng: 31.412, label: 'Gardenia City', zone: 'New Cairo' },
  'gardina city': { lat: 30.082, lng: 31.412, label: 'Gardenia City', zone: 'New Cairo' },
  amorada: { lat: 30.025, lng: 31.595, label: 'Amorada', zone: '5th Settlement' },
  'city gate': { lat: 30.015, lng: 31.545, label: 'City Gate', zone: 'New Cairo' },
  'trio gardens': { lat: 30.065, lng: 31.625, label: 'Trio Gardens', zone: '5th Settlement' },
  'the address east': { lat: 30.045, lng: 31.565, label: 'The Address East', zone: '5th Settlement' },
  'village gate': { lat: 30.022, lng: 31.505, label: 'Village Gate', zone: '5th Settlement' },
  'promenade wadi degla': { lat: 30.038, lng: 31.525, label: 'Promenade Wadi Degla', zone: '5th Settlement' },
  'the icon residence': { lat: 30.042, lng: 31.535, label: 'The Icon Residence', zone: '5th Settlement' },
  'beit al watan': { lat: 30.045, lng: 31.615, label: 'Beit Al Watan', zone: '5th Settlement' },
  'first district': { lat: 30.015, lng: 31.435, label: 'First District', zone: '5th Settlement' },
  'second district': { lat: 30.022, lng: 31.442, label: 'Second District', zone: '5th Settlement' },
  'fifth district': { lat: 30.028, lng: 31.455, label: 'Fifth District', zone: '5th Settlement' },
  'el defaa el watany': { lat: 30.035, lng: 31.465, label: 'El Defaa El Watany', zone: '5th Settlement' },
  'ain sokhna': { lat: 29.6, lng: 32.31, label: 'Ain Sokhna', zone: 'Ain Sokhna' },
  sokhna: { lat: 29.6, lng: 32.31, label: 'Ain Sokhna', zone: 'Ain Sokhna' },
