      ...
      try {
        ...
        for (const docSnap of snapshot.docs) {
          ...
          await docSnap.ref.update({
            isStale: true,
            maintenanceNotes: `Automated hygiene flag: Updated more than 30 days ago (last update: ${_optionalChain([docData, 'access', _ => _.updatedAt, 'optionalAccess', _2 => _2.toDate, 'call', _3 => _3(), 'optionalAccess', _4 => _4.toISOString, 'call', _5 => _5()]) || 'unknown'}).`,
