 function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }import { getRecord, getSupabaseAdmin, updateRecord } from '@sierra-estates/db';
import { COLLECTIONS } from '../models/schema';
import { sharedMemory, openMemoryClient } from '../../../../packages/memory-engine/src/index.js';
...
export class MemoryService {
   ...
   */
  static async recordRejection(leadId, unitId, reason) {
    ...
    try {
      ...
      const intelligence = { ...(_nullishCoalesce(_optionalChain([lead, 'optionalAccess', _ => _.intelligence]), () => ( {}))) };
      ...
      intelligence.memory = {
        ...
        negativeSignals: [
          ...(_nullishCoalesce(_optionalChain([intelligence, 'access', _2 => _2.memory, 'optionalAccess', _3 => _3.negativeSignals]), () => ( []))),
  ...
  static async getGlobalTrends() {
   ...
   static categorizeReason(reason) {
