...
export class VoiceService {
   static __initStatic() {this.ELEVENLABS_API_KEY = process.env.ELEVENLABS_API_KEY}
   static __initStatic2() {this.VOICE_ID = process.env.LEILA_VOICE_ID || 'pNInz6obpg8nEByWQX7L'} // Default professional female voice

  /**
   * Generates a voice note for a lead and stores the signal in Firestore.
   */
  static async generateSierraVoiceNote(leadId, text) {
...
} VoiceService.__initStatic(); VoiceService.__initStatic2();
