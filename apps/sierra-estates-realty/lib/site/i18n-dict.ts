...
export const I18N = {
    en: {
      ...
      heroEyebrow: 'EGYPT’S #1 AI-DRIVEN REAL ESTATE ECOSYSTEM',
      heroHeadline: 'EGYPT’S #1 AI-DRIVEN REAL ESTATE ECOSYSTEM',
      ...
      heroSub: 'The Only Specialized Network for Resale and Rentals Dominating New Cairo, The 5th Settlement, Madinaty, Shorouk, and Rehab',
      heroPunchline: 'Powered by proprietary AI and a robust alliance of 500+ real estate firms and 1,500+ certified brokers to guarantee East Cairo\'s most competitive opportunities at accurate pricing.',
      heroBadgeAgencies: '500+ Partner Agencies',
      heroBadgeBrokers: '1,500+ Certified Brokers',
      heroBadgePricing: 'Proprietary AI Pricing',
      heroFooterStrip: '500+ Partner Agencies | 1,500+ Certified Brokers | Instant AI Verification',
      heroWebTop: 'EGYPT’S #1 AI-DRIVEN REAL ESTATE ECOSYSTEM',
      heroWebCenter: 'The Definitive Network for Resale & Rentals Dominating New Cairo, The 5th Settlement, Madinaty, Shorouk, and Rehab.',
      heroWebFooter: '500+ Partner Agencies | 1,500+ Certified Brokers | Instant AI Verification',
      heroMobileHeader: 'EGYPT’S #1 AI PROPTECH ENGINE',
      heroMobileBody: 'Resale & Rentals Dominating New Cairo, Madinaty, Shorouk & Rehab.',
      heroMobileCallout: 'Powered by AI • 500+ Agencies • 1,500+ Brokers',
      heroBillboardPrimary: 'EGYPT’S #1 AI REAL ESTATE ECOSYSTEM',
      heroBillboardSub: 'Dominating Resale & Rentals in New Cairo, The 5th Settlement, Madinaty, Shorouk & Rehab',
      heroBillboardTagline: 'Best Deals. Verified Prices. Guaranteed Opportunities.',
      q1: '500+ Partner Agencies', q2: '1,500+ Certified Brokers', q3: 'Proprietary AI Pricing',
      ...
      aiRadarT: 'Listing Net Radar', aiRadarS: 'Target up to 40 units on map radar with 1-hour WhatsApp verification.',
    ...
    ar: {
      ...
      heroEyebrow: 'أول محرك ذكاء اصطناعي عقاري متكامل في مصر',
      heroHeadline: 'أول محرك ذكاء اصطناعي عقاري متكامل في مصر',
      ...
      heroSub: 'الشبكة الأكثر تخصصاً في الإيجار وإعادة البيع.. السيطرة الكاملة على القاهرة الجديدة، التجمع الخامس، مدينتي، الشروق، والرحاب',
      heroPunchline: 'بفضل الذكاء الاصطناعي وشبكتنا المكونة من أكثر من 500 شركة عقارية و1,500 وسيط معتمد؛ نضمن لك الوصول لأفضل الفرص الحصرية وأدق الأسعار في شرق القاهرة بضغطة زر واحدة.',
      heroBadgeAgencies: '+500 شركة شريكة',
      heroBadgeBrokers: '+1,500 وسيط معتمد',
      heroBadgePricing: 'أدق تسعير بذكاء اصطناعي',
      heroFooterStrip: '+500 شركة شريكة | +1,500 وسيط معتمد | تحقق فوري بالذكاء الاصطناعي',
      heroWebTop: 'أول محرك ذكاء اصطناعي عقاري متكامل في مصر',
      heroWebCenter: 'الشبكة الأكثر تخصصاً في الإيجار وإعادة البيع.. السيطرة الكاملة على القاهرة الجديدة، التجمع الخامس، مدينتي، الشروق، والرحاب.',
      heroWebFooter: '+500 شركة شريكة | +1,500 وسيط معتمد | تحقق فوري بالذكاء الاصطناعي',
      heroMobileHeader: 'المحرك العقاري الأول بالذكاء الاصطناعي في مصر',
      heroMobileBody: 'إيجار وإعادة بيع.. السيطرة الكاملة على القاهرة الجديدة، مدينتي، الشروق والرحاب.',
      heroMobileCallout: 'مدعوم بالذكاء الاصطناعي • +500 شركة • +1,500 وسيط',
      heroBillboardPrimary: 'أول منظومة عقارية بالذكاء الاصطناعي في مصر',
      heroBillboardSub: 'السيطرة على الإيجار وإعادة البيع في القاهرة الجديدة، التجمع الخامس، مدينتي، الشروق والرحاب',
      heroBillboardTagline: 'أفضل الصفقات. أسعار موثقة. فرص مضمونة.',
      q1: '+500 شركة شريكة', q2: '+1,500 وسيط معتمد', q3: 'أدق تسعير بذكاء اصطناعي',
      ...
      aiRadarT: 'رادار اصطياد وتأكيد الوحدات', aiRadarS: 'شبكة خريطة حية لاختيار حتى 40 وحدة والتحقق الفوري مع الملاك خلال 60 دقيقة.',
