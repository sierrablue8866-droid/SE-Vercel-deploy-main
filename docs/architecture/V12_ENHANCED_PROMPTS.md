# 🔳 Sierra Estates: ENHANCED V12.0 MASTER PROMPTS

These prompts have been optimized with **Micro-Level Intelligence** to ensure the highest fidelity output from Blink.new, Cursor, or v0.dev.
...
**Core Identity**: High-end PropTech OS using AI-Powered Real Estate Intelligence.
**Aesthetic**: Apple-style minimalism, 'Quiet Luxury', Editorial Typography.
**Key Colors**: Royal Blue (#152445), Sky Blue (#3B82F6), Bronze Gold (#C5A059), Sunset Ivory (#FDFCF8).
**Typography**: Playfair Display (Headings), Inter (UI/Numbers), Cairo (Arabic).
**Performance Mandate**: Next.js 16, React 19, Framer Motion. Ensure Core Web Vitals (LCP < 2.5s). Use staggered animations (50ms tactile feedback).
**Logic**: All pricing follows SBR Coding: `[Compound]-[Rooms][Furnish]-[Price]`.
**Content Strategy**: The #1 real estate site for New Cairo (5th Settlement). Primary slogan: 'Beyond Brokerage'."
...
4. **Matched Selection**: A mobile-first Gallery (S8) showing 'Neural Match Scores' and a pre-filled WhatsApp 'Request Viewing' CTA.
5. **Portals**: Institutional Admin Dashboard and CRM Intelligence view.
Palette: Sky Blue, Navy, Gold. Feel: Institutional, Exclusive, and Intelligent."
