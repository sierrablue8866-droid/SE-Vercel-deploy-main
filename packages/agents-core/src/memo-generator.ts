...
export interface TearSheetListingInput {
  referenceId: string;
  title: string;
  compoundName: string;
  unitType: string;
  ...
  bedrooms: number;
  bathrooms: number;
  finishing: 'core_and_shell' | 'semi_finished' | 'fully_finished' | 'ultra_lux';
...
export class TearSheetGenerator {
   ...
   */
  public static generateTearSheet(input: TearSheetListingInput): ExecutiveTearSheet {
