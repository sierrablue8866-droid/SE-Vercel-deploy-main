      ...
      if (process.env.ANTHROPIC_API_KEY) {
        try {
          ...
          if (anthropicModule && anthropicModule.Anthropic) {
            ...
            return _optionalChain([message, 'access', _ => _.content, 'access', _2 => _2[0], 'optionalAccess', _3 => _3.type]) === 'text' ? message.content[0].text : '';
          }
        } catch (e) {
...
;
          return _optionalChain([data, 'access', _4 => _4.candidates, 'optionalAccess', _5 => _5[0], 'optionalAccess', _6 => _6.content, 'optionalAccess', _7 => _7.parts, 'optionalAccess', _8 => _8[0], 'optionalAccess', _9 => _9.text]) || this.generateFallbackProposal(context);
        }
      } catch (err) {
...
للتنسيق وحجز معاينة فورا، تواصل معنا مباشرة.`;
  ...
  async analyzeCounterOffer(
    ...
    const askingPrice = (_optionalChain([context, 'access', _10 => _10.propertyData, 'optionalAccess', _11 => _11.price]) ) || counterOffer.amount * 1.1;
