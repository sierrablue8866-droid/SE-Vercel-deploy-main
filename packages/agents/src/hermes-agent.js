...
export class HermesAgentCore {constructor() { HermesAgentCore.prototype.__init.call(this);HermesAgentCore.prototype.__init2.call(this); }
    __init() {this.name = 'Hermes-Agent'}
    __init2() {this.version = 'v2.4'}

  async analyzeCompound(compoundName) {
    const defaultData = {
      Mivida: {
