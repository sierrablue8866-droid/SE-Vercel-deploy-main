...
export const canonicalize_token = (tok) => {
    if (!tok) return "";
...
export const canonical_tokens_from_text = (text) => {
    const res = [];
...
export const synonyms_for = (tok) => {
    const can = canonicalize_token(tok);
    return slook.get(can) || new Set([can]);
};

export const build_search_doc = (text) => {
...
export const build_fts_query = (text) => {
    const can = canonical_tokens_from_text(text);
...
export const canonical_token_set = (text) => {
    return new Set(canonical_tokens_from_text(text));
};

export const stable_text_fallback_hash = (text) => {
    return crypto
...
export const add_synonym_tokens = (toks) => {
    const res = new Set();
