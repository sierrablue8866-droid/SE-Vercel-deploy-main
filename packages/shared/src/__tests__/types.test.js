...
describe('Enum / Union Types', () => {
  ...
  it('FinishingLevel has 4 values', () => {
    const levels = ['core_shell', 'semi', 'fully_finished', 'ultra_lux'];
  ...
  it('RequestStatus has 3 workflow states', () => {
    const statuses = ['bot_handling', 'ready_for_agent', 'closed'];
  ...
  it('DeliveryStatus has 3 values', () => {
    const statuses = ['ready', 'under_construction', 'off_plan'];
    expect(statuses).toHaveLength(3);
  });
...
describe('Timestamp type', () => {
  it('has seconds + nanoseconds', () => {
    const t = { seconds: 1700000000, nanoseconds: 0 };
