...
DEAD_DIRS=(
  ...
  # NOTE: .agent/ is ACTIVE — contains all AI skills, workflows, and rules. DO NOT archive.
)
...
OLD_FRONTENDS=(
  ...
  # NOTE: apps/sierra-estates-realty is the ACTIVE production Next.js app — DO NOT archive.
)
