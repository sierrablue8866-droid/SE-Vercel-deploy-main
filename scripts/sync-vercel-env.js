...
export const CLIENT_ENV_VARS = {
  ...
  AIRTABLE_SCRAPER_TABLE: process.env.AIRTABLE_SCRAPER_TABLE,

  // WhatsApp & Gateway Enhancements
  ...
  NEXT_PUBLIC_CONTACT_PHONE: process.env.NEXT_PUBLIC_CONTACT_PHONE || '+201092048333',
